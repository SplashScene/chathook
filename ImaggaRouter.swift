...
//  PlayLife
//
//  Created by Kevin Farm on 5/2/16.
...
public enum ImaggaRouter: URLRequestConvertible{
    ...
    static let authenticationToken = "Basic YWNjXzYwMGNhYjZkYjhiNTllYjo5ZTE0OTJkZmM2ZjJkNzBkZGIwMjFiNzVmM2JmNWZiNQ=="
    ...
    public var URLRequest: NSMutableURLRequest{
        let result: (path: String, method: Alamofire.Method, parameters: [String: AnyObject]) = {
            switch self {
            case .Content: return("/content", .POST, [String: AnyObject]())
